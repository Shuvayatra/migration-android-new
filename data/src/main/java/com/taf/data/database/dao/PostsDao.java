...
import com.taf.data.database.dao.Posts;

// THIS CODE IS GENERATED BY greenDAO, DO NOT EDIT.
/** 
 * DAO for table "POSTS".
*/
public class PostsDao extends AbstractDao<Posts, Long> {

    public static final String TABLENAME = "POSTS";

    /**
     * Properties of entity Posts.<br/>
    ...
    */
    ...
    public PostsDao(DaoConfig config) {
        super(config);
    }
    
    public PostsDao(DaoConfig config, DaoSession daoSession) {
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, Posts entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public Posts readEntity(Cursor cursor, int offset) {
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, Posts entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(Posts entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(Posts entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
